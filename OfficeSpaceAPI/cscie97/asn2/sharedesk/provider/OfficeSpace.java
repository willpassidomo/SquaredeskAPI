 ...
 */
public class OfficeSpace implements Rateable {
    ...
    private List<PrivateFeature> privateFeatures = new ArrayList<PrivateFeature>();
    private List<CommonFeature> commonFeatures = new ArrayList<CommonFeature>();
    private List<Rating> ratings = new ArrayList<Rating>(); 
    private Address address;
    private List<Imagec> image = new ArrayList<Imagec>();
    private static List<OfficeSpace> officeSpaces = new ArrayList<OfficeSpace>();
    ...
    public static OfficeSpaceBuilder newOfficeSpace () {
        return new OfficeSpaceBuilder();
    }
    ...
    public static FacilityType newFacilityType (String facilityType) {
        FacilityType ffacilityType = FacilityType.newFacilityType(facilityType);
        return ffacilityType;
    }
    
    public static FacilityType getFacilityTypes () {
        return FacilityType.getFacilityTypes().get(0);
    }
