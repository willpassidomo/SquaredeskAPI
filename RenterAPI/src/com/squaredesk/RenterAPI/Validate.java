...
public class Validate {
    static Object checkNotNull(String methodName, Object o) {
        if (o!=null) {
            return o;
        }
    ...
    static String checkAllChars(String methodName, String testString) {
        char[] chars = testString.toCharArray();
        for (char testChar: chars){
            if(!Character.isLetter(testChar) && !Character.isSpaceChar(testChar)) {
    ...
    static int testRange(String methodName, int testInt, int min, int max) {
        if(testInt < min) {
    ...
    static boolean checkDateOrder(Date startDate, Date endDate) {
